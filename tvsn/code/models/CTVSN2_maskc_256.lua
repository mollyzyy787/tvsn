...
function DCGAN.create_netG(opts)
	...
	table.insert(inputs,output_mask)

	local input_im_maskc = nn.JoinTable(2)({input_im,output_mask})
  -- 3 x 256 x 256 
	local en_conv1 = nn.LeakyReLU(0.2, true)(nn.SpatialBatchNormalization(16)(nn.SpatialConvolution(4,16,4,4,2,2,1,1)(input_im_maskc)))
  -- 16 x 128 x 128
  ...
  -- 512 x 4 x 4
	...
	-- code
	-- (512+128) x 4 x 4
	local concat2 = nn.SpatialFullConvolution(512+512+128,512,3,3,1,1,1,1)(concat1)
